...
@section('content')
  ...
  <h2 class="mt-4 text-3xl md:text-center font-comfortaa font-bold text-[#474747]"> Nouveau(x) Document </h2>

  <form class="flex flex-col md:items-center pt-3" action="{{ route('documents.create') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="flex flex-col mb-4">
      ...
      <button id="documents-btn" type="button" class="w-full xxs:w-[350px] text-left text-sm px-2 py-1 font-inter rounded-sm bg-white text-black border border-[#CACACA]">Cliquez ici pour selectionner des fichiers</button>
    ...
    <input class="mb-35 w-[45%] xs:w-[200px] mt-6 text-lg px-2 py-1 font-inter rounded-xl bg-linear-to-r from-[#FD814A] to-[#FC5C4C] text-white" type="submit" name="submit" value="Créer">
  </form>
